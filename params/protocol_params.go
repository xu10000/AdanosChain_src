...
var (
	...
	MinGasLimit            = big.NewInt(150000000)             // Minimum the gas limit may ever be.
	GenesisGasLimit        = big.NewInt(150000000)             // Gas limit of the Genesis block.
	...
	HardForkV1 = big.NewInt(154422) // HardForkV1 fork
